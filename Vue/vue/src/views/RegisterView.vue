<template>
  <div id="login">
    <div class="nav">
        已经拥有账号，<router-link to="/login" style="text-decoration: none;color:rgb(248, 104, 128);">前往登录页面</router-link>
    </div>
    <div class="card">
        ...
        >
            ...
            <el-form-item style="margin-top: -5px;" prop="check">
                <div class="tag">确认密码</div>
                <el-input v-model="form.check" clearable show-password>
                    <template #prefix>
                        <el-icon class="el-input__icon"><Lock /></el-icon>
                    </template>
                </el-input>
    ...
    data() {
        return {
            ...
            rules: {
                ...
                check: {required: true, message: "请确认密码", trigger: 'blur'},
            }
        }
    },
    components: {
